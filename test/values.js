...
test('has', function (t) {
  ...
  t.equal(inspect({ a: 1, b: 2 }), endent`{
    "a": 1,
    "b": 2
  }`);
...
test('Set', { skip: typeof Set !== 'function' }, function (t) {
  ...
  t.equal(inspect(set), expectedString, 'new Set([{\n"a": 1 }\n, [\n"b"\n]\n]) should show size and contents');
...
test('RegExps', function (t) {
  t.equal(inspect(/a/g), '"RegExp /a/g"', 'regex shows properly');
  t.equal(inspect(new RegExp('abc', 'i')), '"RegExp /abc/i"', 'new RegExp shows properly');
